class AudioPreProcessParams:
    def __init__(self, text_segments=None, audio_profile_path=None, 
                 speed_slider=None, temperature=None, top_P=None, top_K=None
                 ,refine_oral=None, refine_laugh=None, refine_break=None,
                 refine_text_flag=None, nums2text_switch=None, concatenate_audio=None, 
                 emb_upload=None, emb_upload_path=None, srt_flag=None):
...
class AudioProcessParams:
    def __init__(self, text_segments=None, aduio_profile_path=None, speed_slider=None, temperature=None, top_P=None,
                 top_K=None, refine_oral=None, refine_laugh=None, refine_break=None):
        self.text_segments = text_segments
...
class TextProcessParams:
    def __init__(self, txt_file=None, split_text_flag=None, text=None, segment_length=None):
